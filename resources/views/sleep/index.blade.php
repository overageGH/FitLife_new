...
<div class="dashboard-main" id="dashboard-main">
    ...
    <div class="dashboard-header">
        ...
        <p>Log your sleep and track your health.</p>
    </div>

    <!-- Success Alert -->
    @if(session('success'))
    <div class="biography-card alert success">
        <p>{{ session('success') }}</p>
    </div>
    @endif
    ...
    <div class="history-section">
        <h2><i class="fas fa-bed"></i> Sleep History</h2>
        <div class="table-wrapper">
            <table>
                ...
                @empty
                    <tr><td colspan="4" class="no-data">No sleep records yet.</td></tr>
                @endforelse
                </tbody>
            </table>
        </div>
    ...
    @if($average)
    <div class="biography-card alert success">
        <p>Average sleep: <strong>{{ round($average, 1) }} hours</strong></p>
    </div>
    @endif
</div>
...
<div class="side-menu" id="side-menu">
    ...
    <ul>
        ...
        <li><a href="{{ route('sleep.index') }}" class="active"><i class="fas fa-bed nav-icon"></i> Sleep Tracker</a></li>
...
@media (max-width: 480px) {
    ...
    .biography-card, .history-section {
        padding: 1rem;
    }
}
...
@media (prefers-reduced-motion: reduce) {
    .biography-card, .history-section, .menu-btn, .side-menu, .calculate-btn {
        transition: none;
    }
}
