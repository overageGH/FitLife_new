...
<div class="dashboard-main" id="dashboard-main">
    ...
    <div class="dashboard-header">
        ...
        <p>Log your daily water intake and stay hydrated!</p>
    </div>

    <!-- KPI Card -->
    <div class="kpi-container">
        <div class="kpi-card">
            <h3>Total Water Today (ml)</h3>
            <p>{{ $logs->sum('amount') ?? 0 }}</p>
        </div>
    </div>
    ...
    <div class="biography-card">
        ...
        <form action="{{ route('water.store') }}" method="POST" class="form-logging">
            @csrf
            <div class="form-group">
                <label>Amount (ml):</label>
                <input type="number" name="amount" placeholder="Amount (ml)" required>
            </div>
    ...
    <div class="history-section">
        <h2><i class="fas fa-tint"></i> History</h2>
        @if($logs->isEmpty())
            <p class="no-data">No water logs yet.</p>
        @else
...
<div class="side-menu" id="side-menu">
    ...
    <ul>
        ...
        <li><a href="{{ route('water.index') }}" class="active"><i class="fas fa-tint nav-icon"></i> Water Tracker</a></li>
...
@media (max-width: 480px) {
    ...
    .biography-card, .history-section, .kpi-card {
        padding: 1rem;
    }
}
...
@media (prefers-reduced-motion: reduce) {
    .biography-card, .history-section, .kpi-card, .menu-btn, .side-menu, .calculate-btn {
        transition: none;
    }
}
